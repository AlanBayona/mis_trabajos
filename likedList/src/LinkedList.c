...
int ll_len(LinkedList* this)
{
    ...
    if(this!=NULL)
    {
    	Node* nodoAux=(Node*)malloc(sizeof(Node));
    	Node* nodo_dosAux=(Node*)malloc(sizeof(Node));
    	if(nodoAux!=NULL && nodo_dosAux!=NULL)
    	{
    		returnLen=0;
    		nodoAux=this->pFirstNode;
			while(nodoAux->pNextNode!=NULL)
			{
...
static Node* getNode(LinkedList* this, int nodeIndex)
{
	...
	if(this!=NULL && nodeIndex<=ll_len(this) && nodeIndex>=0 && nodoRetorno!=NULL)
	{
		if(nodeIndex==0)
		{
...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    if(this!=NULL && nodeIndex>0 && nodeIndex<ll_len(this) && pElement!=NULL && nodoAuxiliar!=NULL)
    {
...
LinkedList* ll_clone(LinkedList* this)
{
    ...
    if(cloneArray!=NULL && nodoAuxiliar!=NULL)
    {
    	for(int i=0; i<ll_len(this); i++)
    	{
...
//pasa todo los elementos a la funcion que hara un cambio en la lista
